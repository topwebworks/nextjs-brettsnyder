...
const personalValues = [
  ...
  },
  {
    ...
    details: "I've built design systems that saved teams real time on delivery, translating brand guides into core CSS root variables and shared components. I follow the same principle for client work: consistent styling and a system that scales cleanly as a site grows.",
    icon: Layers,
